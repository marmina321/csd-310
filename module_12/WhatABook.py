...
def display_books():
    ...
    clear()
    lab= [ "ID","Title","Author","Details"]
    print(f"{lab[0]:<2} {lab[1]:<30}  {lab[2]:<30} {lab[3]:<50} \n")
    for book in books:        
        print(f"{book[0]:<2} {book[1]:<30}  {book[2]:<30} {book[3]:<50} ")     
...
def display_wishlist(user_id):
    ...
    if wishlist:
        ...
        for book in wishlist:
            ...
            print(f"{book_details[0]:<2} {book_details[1]:<30}  {book_details[2]:<30} {book_details[3]:<50} ")                
    else:
